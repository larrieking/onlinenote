...
if(!$result){
    ...
    $message = "Please click on this link to prove that you owns this email:\n\n";
$message .= "http://mycodershift.host20.uk/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
