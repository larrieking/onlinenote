...
if(empty($_POST["originalEmail"])){
    $errors .= $missingEmail;   
}else{
    $email = filter_var($_POST["originalEmail"], FILTER_SANITIZE_EMAIL);
...
$message .= "http://mycodershift.host20.uk/myonlinenote/resetpassword.php?user_id=$user_id&key=$key";
