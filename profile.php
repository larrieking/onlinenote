...
if($count == 1){
   ...
   // $row = mysqli_fetch_array($result, MYSQL_ASSOC); 
    ...
    $error = "There was an error retrieving the username and email from the database";   
}
?>
<!DOCTYPE html>
<html lang="en">
...
<!--Container-->
      <div class="container" id="container">
          <div class="row">
              <div class="col-md-offset-3 col-md-6">
                  ...
                  <h2>General Account Settings:<?php echo $error; ?></h2>
    ...
    <!-- Footer-->
      <div class="footer">
          <div class="container">
              <p>Codershift.com Copyright &copy; 2015-<?php $today = date("Y"); echo $today?>.</p>
          </div>
      </div>
